...
import JobTracker from "@/containers/job-tracker/JobTracker";
...
const JobsTrackerPage = async () => {
  ...
  if (session) {
    ...
    return (
      <ContentLayout title={"Jobs-tracker"}>
        <JobTracker interviews={data.interviews} />
      </ContentLayout>
    );
  }
...
export default JobsTrackerPage;
