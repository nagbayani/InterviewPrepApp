    ...
    <Dialog>
      ...
      <DialogContent className='w-[600px] overflow-y-scroll h-[500px] translate-y-[-25%]'>
        <DialogHeader>
          ...
          <DialogDescription>
            Click the "Generate" button to automatically create a list of
            interview questions for this deck based on its topic.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className='grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-4 p-4'>
          {generatedQuestions.length > 0 ? (
            ...
            <p>No questions generated yet. Click "Generate" to create some.</p>
          )}
        </div>
