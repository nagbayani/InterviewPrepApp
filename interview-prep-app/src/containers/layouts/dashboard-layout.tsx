...
export default function DashboardLayout({
  ...
  return (
    <>
      <div className='fixed w-full h-100vh overflow-visible'>
        <Sidebar />
        <main
          className={cn(
            " overflow-scroll h-[100vh] min-h-[calc(100vh_-_56px)] bg-zinc-50 dark:bg-zinc-900  transition-[margin-left] ease-in-out duration-300 ",
